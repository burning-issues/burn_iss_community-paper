...
plot(bigram_graph, rescale= FALSE, ylim = c(-7,7),xlim = c(1,-5),asp=0, edge.arrow.size=.8,vertex.color = "pink", vertex.size =deg*10,vertex.frame.color="deeppink",vertex.label.color="black", vertex.label.cex=0.75,vertex.label.dist=0.8,edge.curve = 0.75,edge.color="skyblue",edge.label.family="Arial")
